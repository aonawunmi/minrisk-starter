...
export default function HelpTab() {
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { children: [_jsxs(CardTitle, { className: "flex items-center gap-2", children: [_jsx(BookOpen, { className: "h-5 w-5" }), "User Manual & Help"] }), _jsx(CardDescription, { children: "Complete guide to using MinRisk effectively" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: expandAll, className: "text-sm text-blue-600 hover:underline", children: "Expand All" }), _jsx("span", { className: "text-gray-300", children: "|" }), _jsx("button", { onClick: collapseAll, className: "text-sm text-blue-600 hover:underline", children: "Collapse All" })] })] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "relative", children: [_jsx(Search, { className: "absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400" }), _jsx(Input, { placeholder: "Search manual... (e.g., 'delete risk', 'archive', 'permissions')", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: "pl-10" })] }) })] }), _jsx("div", { className: "space-y-4", children: sections.map((section) => {
