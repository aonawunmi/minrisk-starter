...
-- This table stores historical risk data from previous periods
...
-- Index for fast period-based queries (critical for report generation)
...
-- RLS policies for risk_history (same as risks table)
ALTER TABLE risk_history ENABLE ROW LEVEL SECURITY;

-- Policy: Users can view risk history for their organization
...
-- Policy: Admins can insert into risk_history (for archiving)
...
-- Policy: Admins can delete from risk_history
