-- Migration: Super Admin Read-Only Access - V2
...
-- Drop the blanket "manage all users" policy if it exists
DROP POLICY IF EXISTS "Super admins can manage primary admins only" ON user_profiles;
